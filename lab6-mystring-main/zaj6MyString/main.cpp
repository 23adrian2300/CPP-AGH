...
constexpr const char* const FIRSTNAME = "Adrian";
constexpr const char* const SURNAME   = "Żerebiec";
constexpr const char* const MAIL    = "zerebiec@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "412306";
