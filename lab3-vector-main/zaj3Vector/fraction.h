...
public:
    ...
    //settery i gettery
    [[nodiscard]] auto denominator() const { return denominator_; };
    void setDenominator(int denominator);
    [[nodiscard]] auto numerator() const { return numerator_; };
    ...
    //zminieszanie ułamka
    static Fraction reducingFraction(Fraction fraction);
